<div class="user-modal">
  ...
  <div class="user-modal_hidden">
    ...
    <div class="user-modal_basket">
      ...
      <table class="user-modal_table user-modal_tableBasket">
    ...
    <div class="user-modal_basket-footer">
      ...
      <div class="links">
        <div class="link-box"><button class="link exit_btn">Продолжить покупки</button><span class="link__text">Вернуться к выбору
            товаров</span></div>
        <div class="link-box"><a href="/warmhouse/basket.php" class="link">Перейти в корзину</a><span class="link__text">Полноценное
